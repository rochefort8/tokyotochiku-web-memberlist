            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <router-link to="/newsletter" class="btn btn-default">送付者一覧</router-link>
                  <!--
    ...
    export default {
      components: {
        ...
        methods: {
          loadMembers(page = 1){
              var app = this;
              var url = '/api/newsletter?undelivered=true&?page=' + page ;
